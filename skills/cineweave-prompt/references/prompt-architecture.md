...
2. subject identity or object structure;
3. current visible state and action;
4. environment and subject–environment relation;
5. viewpoint, framing, composition and depth;
6. physical light sources, shadow behavior and exposure relation;
7. material response and surface condition;
8. representational medium and style treatment;
9. canvas, aspect ratio and delivery constraints;
10. targeted failure prevention.
