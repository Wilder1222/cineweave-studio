...
5. Block subjects into declared scene zones before choosing a lens or movement.
6. Give the performance an observable action, not only an emotion label.
7. Choose one dominant visual target and one dominant camera idea.
8. End the shot on stable character and scene states.
