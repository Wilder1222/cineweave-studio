...
description: Turn a CineWeave World context and creator intent into Codex-owned directing proposals, a structured DirectingSpec input, and an interactive visual draft brief. Use for World-first cinematic development, composition, cinematography, costume, architecture, atmosphere, sound-edit and repair decisions before any external Provider handoff.
---
...
### 4. Prepare the Codex draft brief
...
### 5. Describe repairs without performing them
...
4. Check that the Skill receipt is actual, not a placeholder.
5. Check that no secret, signed URL or private media content is present.
6. Check that the output does not claim a Provider task ID or a Canon mutation.
